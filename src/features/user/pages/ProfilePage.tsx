...
// Datos de ejemplo de carros del usuario
const carrosUsuario = [
  {
    id: "1",
    marca: "Honda",
...
// Historial de pedidos de los últimos 3 meses
    ...
    items: [
      {
        ...
        reseñaProducto: {
          rating: 5,
          comentario: "Excelente filtro, mejoró notablemente el rendimiento"
        },
        reseñaTaller: {
          rating: 5,
          comentario: "Instalación perfecta y servicio profesional"
        }
      },
      {
        id: "trans_001",
    ...
    items: [
      {
        ...
        reseñaProducto: {
          rating: 4,
          comentario: "Buenos neumáticos, duran bastante"
        },
        reseñaTaller: {
          rating: 4,
          comentario: "Buen servicio aunque tardaron un poco más de lo esperado"
        }
      }
    ],
...
export function UserProfilePage({ onRegresar, initialTab = "personal", onTabChange }: PerfilUsuarioProps) {
  ...
  const [nombres, setNombres] = useState(usuario?.tipo === "usuario" ? usuario.nombres : usuario?.nombre || "");
  const [email, setEmail] = useState(usuario?.email || "");
  const [telefono, setTelefono] = useState(usuario?.tipo === "usuario" ? usuario.telefono || "" : "");
  const [direccion, setDireccion] = useState("Av. Amazonas N24-03 y Colón, Quito");
  
  // Estados para carros
  const [carros, setCarros] = useState(usuario?.carros || carrosUsuario);
  const [mostrarDialogoAgregarCarro, setMostrarDialogoAgregarCarro] = useState(false);
  const [carroEditando, setCarroEditando] = useState<any>(null);
  
  // Estados para nuevo carro
    ...
    <div className="container mx-auto px-4 py-6 max-w-6xl">
                ...
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription>
                        Administra tus vehículos para recomendaciones personalizadas
                      </CardDescription>
                    </div>
            ...
            <TabsContent value="pedidos">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Revisa tus compras recientes y deja reseñas
                  </CardDescription>
                </CardHeader>
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              {item.reseñaProducto ? (
                                ...
                                <Button 
                                  size="sm" 
                                  variant="outline"
                                  onClick={() => handleAbrirReseña(pedido.id, item.id, "producto")}
                                >
                              ...
                              {item.reseñaTaller ? (
                                ...
                                <Button 
                                  size="sm" 
                                  variant="outline"
                                  onClick={() => handleAbrirReseña(pedido.id, item.id, "taller")}
                                >
            ...
            <TabsContent value="direcciones">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Administra tus direcciones para envíos
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <TabsContent value="configuracion">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Administra tus preferencias y notificaciones
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
      ...
      <Dialog open={mostrarDialogoAgregarCarro} onOpenChange={setMostrarDialogoAgregarCarro}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Agrega un vehículo para recibir recomendaciones personalizadas
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNuevoCarro(prev => ({...prev, marca: e.target.value}))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNuevoCarro(prev => ({...prev, modelo: e.target.value}))}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNuevoCarro(prev => ({...prev, año: parseInt(e.target.value)}))}
                  min="1900"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setNuevoCarro(prev => ({...prev, motor: e.target.value}))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setNuevoCarro(prev => ({ 
                      ...prev, 
                      kilometraje: valor === '' ? 0 : parseInt(valor) || 0 
                    }));
                  }}
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setNuevoCarro(prev => ({...prev, color: e.target.value}))}
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleAgregarCarro}>
                Agregar Vehículo
              </Button>
            </div>
          </div>
      ...
      <Dialog open={mostrarDialogoReseña} onOpenChange={setMostrarDialogoReseña}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              Reseñar {nuevaReseña.tipo === "producto" ? "Producto" : "Taller"}
            </DialogTitle>
            <DialogDescription>
              {reseñaActual && (
                <>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                {renderStars(nuevaReseña.rating, true, (rating) => 
                  setNuevaReseña(prev => ({...prev, rating}))
                )}
                <span className="text-sm text-muted-foreground ml-2">
                  {nuevaReseña.rating}/5 estrellas
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleGuardarReseña}>
                Publicar Reseña
              </Button>
            </div>
          </div>
