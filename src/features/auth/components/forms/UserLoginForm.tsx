...
export function UserLoginForm({ loading, setLoading, onAuthenticated }: Props) {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    setLoading(true);
    try {
      const session = await login({ email, password, role: "usuario" });

      setLoading(false);
      toast.success(session.user.tipo === "admin" ? "¡Bienvenido Administrador!" : "¡Bienvenido de nuevo!");
